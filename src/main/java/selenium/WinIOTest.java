...
public class WinIOTest {
    ...
    public static void KeyDown(int key) throws Exception{
        KBCWait4IBE();
        WinIo.Instance.SetPortVal(WinIOTest.CONTROL_PORT,0xD2,1);
        KBCWait4IBE();
        WinIo.Instance.SetPortVal(WinIOTest.DATA_PORT,key,1);
    }
    ...
    public static void KeyUp(int key) throws Exception{
        ...
        WinIo.Instance.SetPortVal(WinIOTest.CONTROL_PORT,0xD2,1);
        KBCWait4IBE();
        WinIo.Instance.SetPortVal(WinIOTest.DATA_PORT,(key|0x80),1);
    }
